<?php
    ...
    if ($user->num_rows > 0) {
        ...
        if($method=='GET'){
            //cek parameter request dengan parameter kota
            if(isset($_GET['kode_kab_kota'])){
                //mengambil parameter kota dan simpan dalam variabel kota
                ...
                // query menampilkan data dalam table sekolah berdasarkan kota yang dikirimkan melalui method GET
                $sql = "SELECT * FROM sekolah WHERE kode_kab_kota='$kode_kab_kota'";
