<?php
    ...
    $result = array();
     ...
     if ($user->num_rows > 0) {
        ...
        if($method=='GET'){
            //cek parameter request dengan parameter kecamatan
            if(isset($_GET['kode_kec'])){
                //mengambil parameter kecamatan dan simpan dalam variabel kecamatan
                ...
                // query menampilkan data dalam table sekolah berdasarkan kecamatan yang dikirimkan melalui method GET
                $sql = "SELECT * FROM sekolah WHERE kode_kec='$kode_kec'";
